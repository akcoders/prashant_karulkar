    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-lg-8 text-center">
                <p class="section-eyebrow mb-3"><?php esc_html_e( 'Journal', 'prashant-bootstrap' ); ?></p>
                <h1 class="display-font"><?php bloginfo( 'name' ); ?></h1>
                <p class="lead text-secondary mb-0"><?php bloginfo( 'description' ); ?></p>
            </div>
        </div>
                ...
                while ( have_posts() ) :
                    ...
                    <div class="col-md-6 col-xl-4">
                        <article <?php post_class( 'insight-card' ); ?>>
                            ...
                            <p class="mb-0"><?php echo esc_html( wp_trim_words( get_the_excerpt(), 20 ) ); ?></p>
                        </article>
                    </div>
                <?php endwhile; ?>
            <?php else : ?>
